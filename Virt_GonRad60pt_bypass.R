...
outputraw <- dir("C:/Users/emily/OneDrive/Documents/R Output data/60points/Virt_GonRadius60points")
               ...
               if (!(i==40 && (j==1||j==2))) {
                 if (!(i==42)) {
                   if (!(i==45 && j==2)) {
                     ...
                     setwd("C:/Users/emily/OneDrive/Documents/R Output data/60points/Virt_GonRadius60points")
