...
outputraw <- dir("C:/Users/emily/OneDrive/Documents/R Output data/30points/3Radius30points")
...
for (i in 1:50) {
  ...
  #for each landmark set in this mesh
    ...
    setwd("C:/Users/emily/OneDrive/Documents/R Output data/30points/3Radius30points")
