...
outputraw <- dir("C:/Users/emily/OneDrive/Documents/R Output data/60points/3Radius60points")
  ...
  for (j in 1:3) {
    ...
    if (!(i==28 && (j==1||j==2))) {
      if (!(i==40 && (j==1||j==2))) {
        ...
        setwd("C:/Users/emily/OneDrive/Documents/R Output data/60points/3Radius60points")
